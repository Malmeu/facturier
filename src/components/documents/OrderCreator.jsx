      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="bg-white rounded-lg shadow-sm border p-6 mb-6">
          <div className="flex items-center justify-between">
            ...
            <div className="flex space-x-3">
              ...
              <button className="inline-flex items-center px-4 py-2 bg-green-600 text-white rounded-md shadow-sm text-sm font-medium hover:bg-green-700">
        ...
        <div className="bg-white rounded-lg shadow-sm border p-6">
          <div className="text-center py-20">
            ...
            <h3 className="text-lg font-medium text-gray-900 mb-2">Bon de Commande en développement</h3>
